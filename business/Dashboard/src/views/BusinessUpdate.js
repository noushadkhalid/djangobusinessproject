...
const BusinessUpdate = () => {
    ...
    const updatebusines = async (e) => {
        ...
        if (e.target.website_url) {
            formdata.append("website_url", e.target.website_url.value);
        }
        if (e.target.open_at) {
        ...
        const url = `/api/updatebusiness/${slug}/`;
                                            ...
                                            <form onSubmit={updatebusines}>
                                                <div className="card-body">
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <input type="text" className="form-control" id="exampleInputwebsiteUrl" placeholder="Enter Website Url" name="website_url" />
                                                    </div>
                                                    <div className="row">
                                                        <div className="col-md-4">
                                                            <div className="form-group">
                                                                <label htmlFor="exampleInputPassword1">Enter Address</label>
                                                                <input type="text" className="form-control" id="exampleInputLocation" placeholder="Enter Address" name="address" />
                                                            </div>
                                                        </div>
                                                        <div className="col-md-4">
                                                            <div className="form-group">
                                                                <label htmlFor="exampleInputPassword1">Select Country</label>
                                                                <select className="form-control" style={{ width: '100%' }} name="country">
                                                        ...
                                                        <div className="col-md-4">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="text" className="form-control" id="exampleInputLocation" placeholder="Enter City" name="city" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="form-group">

...
const ApproveBusiness = () => {
    ...
    const [link, setLink] = React.useState('/api/allbusiness/');
    ...
    const handleClickchange = (e) => {
        ...
        if (pagenomber == 1) {
            setLink('/api/allbusiness/');
        }
        else {
            setLink(`/api/allbusiness/?page=${pagenomber}`);
        }
    }
    React.useEffect(() => {
        getBusiness();
                                    ...
                                    <div className="col-12">
                                        <div className="card">
                                            <div className="card-header">
                                                <h3 className="card-title">Approve Business</h3>
                                            </div>
                                            {/* /.card-header */}

...
const ApproveProducts = () => {
    ...
    const [link, setLink] = React.useState('/api/allproducts/');
    ...
    const handleClickchange = (e) => {
        ...
        if (pagenomber == 1) {
            setLink('/api/allproducts/');
        }
        else {
            setLink(`/api/allproducts/?page=${pagenomber}`);
        }
    }
    React.useEffect(() => {
        getBusiness();
                                    ...
                                    <div className="col-12">
                                        <div className="card">
                                            <div className="card-header">
                                                <h3 className="card-title">Approve Products</h3>
                                            </div>
                                            {/* /.card-header */}

...
const ApproveClassifieds = () => {
    const { admin_ask } = React.useContext(AuthContext);
    const [businessdata, setBusinessData] = React.useState([]);
    const [count, setCount] = React.useState(null);
    const [link, setLink] = React.useState('/api/allclassifieds/');
    ...
    const handleClickchange = (e) => {
        ...
        if (pagenomber == 1) {
            setLink('/api/allclassifieds/');
        }
        else {
            setLink(`/api/allclassifieds/?page=${pagenomber}`);
        }
    }
    React.useEffect(() => {
        getBusiness();
                                    ...
                                    <div className="col-12">
                                        <div className="card">
                                            <div className="card-header">
                                                <h3 className="card-title">Approve Classifieds</h3>
                                            </div>
                                            {/* /.card-header */}
...
export default ApproveClassifieds;
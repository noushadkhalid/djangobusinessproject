...
const DealsList = () => {
    ...
    const [link, setLink] = React.useState('/api/particularuserdeals/');
    ...
    const handleClickchange = (e) => {
        ...
        if (pagenomber == 1) {
            setLink('/api/particularuserdeals/');
        }
        else {
            setLink(`/api/particularuserdeals/?page=${pagenomber}`);
        }
    }
    React.useEffect(() => {
        getBusiness();
                            ...
                            <div className="col-12">
                                <div className="card">
                                    <div className="card-header">
                                        <h3 className="card-title">All the Deals that you have created</h3>
                                    </div>
                                    {/* /.card-header */}
                                                    ...
                                                    businessdata && businessdata.map((item) => {
                                                        return (
                                                            <tr>
                                                                ...
                                                                <td><Link className="btn btn-primary" to={`/updatedealform/${item.slug}`}>Edit</Link>
                                                                </td>
                                                                <td>

...
const ClassifiedsList = () => {
    ...
    const [link, setLink] = React.useState('/api/particularuserclassifieds/');
    ...
    const handleClickchange = (e) => {
        ...
        if (pagenomber == 1) {
            setLink('/api/particularuserclassifieds/');
        }
        else {
            setLink(`/api/particularuserclassifieds/?page=${pagenomber}`);
        }
    }
    React.useEffect(() => {
        getBusiness();
                                                    ...
                                                    businessdata && businessdata.map((item) => {
                                                        return (
                                                            <tr>
                                                                ...
                                                                <td><Link className="btn btn-primary" to={`/updateclassifiedform/${item.slug}`}>Edit</Link>
                                                                </td>
                                                                <td>

...
const MultipleLocationUpdate=()=>{
    ...
    const addlocation = async (e) => {
        ...
        const response = await fetch(url, {
            ...
            body: JSON.stringify({ business_slug: 'asgasdgasd', location_slug: slug, address: e.target.address.value, country: e.target.country.value, city: e.target.city.value ,timingfrom:e.target.timingfrom.value,timingto:e.target.timingto.value})
        });
                                            ...
                                            <form onSubmit={addlocation}>
                                                <div className="card-body">
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <input type="text" className="form-control" id="exampleInputLocation" placeholder="Enter Time" name="timingfrom" />
                                                    </div>
                                                    <div className="form-group">
                                                        <label htmlFor="exampleInputPassword1">Close At: Example(11:34 PM)</label>
                                                        <input type="text" className="form-control" id="exampleInputLocation" placeholder="Enter Time" name="timingto" />
                                                    </div>
                                                </div>
...
export default MultipleLocationUpdate;
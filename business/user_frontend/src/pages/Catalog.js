...
const Catalog = () => {
    ...
    const handleClickchange = (e) => {
        ...
        if (pagenomber == 1) {
            setLink('/api/businesslist/');
        }
        else {
            setLink(`/api/businesslist/?page=${pagenomber}`);
        }
    }
    React.useEffect(() => {
        getBusiness();
        ...
        <div>
            <div className="container-fluid mt-5 pt-5 p-0">
                <div className="row g-0 mt-n3">
                    ...
                    <aside className="col-lg-4 col-xl-3 border-top-lg border-end-lg shadow-sm px-3 px-xl-4 px-xxl-5 pt-lg-2 mb-menu">
                    ...
                    <div className="col-lg-8 col-xl-9 position-relative overflow-hidden pb-5 pt-4 px-3 px-xl-4 px-xxl-5">
                        ...
                        <nav className="mb-3 pt-md-2" aria-label="Breadcrumb">
                            <ol className="breadcrumb">
                                ...
                                <li className="breadcrumb-item active" aria-current="page">Find Business</li>
                            </ol>
                        </nav>
                        {/* Title*/}
                        <div className="d-sm-flex align-items-center justify-content-between pb-3 pb-sm-4">
                            <h1 className="h2 mb-sm-0">Find Business</h1><a className="d-inline-block fw-bold text-decoration-none py-1" href="#" data-bs-toggle-className="invisible" data-bs-target="#map"><i className="fi-map me-2" />Map view</a>
                        </div>
                        {/* Sorting*/}

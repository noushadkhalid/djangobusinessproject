...
const DealsCarousel = () => {
    ...
    const firstslide = dealsdata.slice(0, 3);
    const secondslide = dealsdata.slice(4, 7);
    const thirdslide = dealsdata.slice(7, 11);
    return (
        <div>
            ...
            <div>
                <div className="d-sm-flex align-items-center justify-content-between mb-4 pb-2">
                    <h2 className="h3 mb-sm-0">Find Deals</h2><Link className="btn btn-link fw-normal ms-sm-3 p-0" to="/deals">View all<i className="fi-arrow-long-right ms-2" /></Link>
                </div>
                <div id="carouselExampleDark2" className="carousel carousel-dark slide" data-bs-ride="carousel">
                    <div className="carousel-indicators">
                        {
                            firstslide.length > 0 ? <button type="button" data-bs-target="#carouselExampleDark2" data-bs-slide-to={0} className="active" aria-current="true" aria-label="Slide 1" /> : <div style={{ display: 'none' }}></div>
                        }
                        {
                            secondslide.length > 0 ? <button type="button" data-bs-target="#carouselExampleDark2" data-bs-slide-to={1} aria-label="Slide 2" /> : <div style={{ display: 'none' }}></div>
                        }
                        {

        ...
        <div>
            ...
            <div>
                <div className="d-sm-flex align-items-center justify-content-between mb-4 pb-2">
                    <h2 className="h3 mb-sm-0">Find Business</h2><Link className="btn btn-link fw-normal ms-sm-3 p-0" to="/catalog">View all<i className="fi-arrow-long-right ms-2" /></Link>
                </div>

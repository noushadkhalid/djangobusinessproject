...
const Deals = () => {
    ...
    const [link, setLink] = React.useState('/api/dealslist');
    ...
    const handleClickchange = (e) => {
        ...
        if (pagenomber == 1) {
            setLink('/api/dealslist/');
        }
        else {
            setLink(`/api/dealslist/?page=${pagenomber}`);
        }
    }
    React.useEffect(() => {
        getBusiness();
                    ...
                    <div className="col-lg-8 col-xl-9 position-relative overflow-hidden pb-5 pt-4 px-3 px-xl-4 px-xxl-5">
                        ...
                        <nav className="mb-3 pt-md-2" aria-label="Breadcrumb">
                            <ol className="breadcrumb">
                                ...
                                <li className="breadcrumb-item active" aria-current="page">Find Deals</li>
                            </ol>
                        </nav>
                        {/* Title*/}
                        <div className="d-sm-flex align-items-center justify-content-between pb-3 pb-sm-4">
                            <h1 className="h2 mb-sm-0">Find Deals</h1><a className="d-inline-block fw-bold text-decoration-none py-1" href="/deals" data-bs-toggle-className="invisible" data-bs-target="#map"><i className="fi-map me-2" />Map view</a>
                        </div>
                        {/* Sorting*/}
